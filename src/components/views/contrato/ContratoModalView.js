 ...
 *
 */
export class ContratoModalView extends GenericModal {
    ...
    getContrato = () => {
        ...
        if(this.state.selectedCliente === null) {
            this.mostrarMensajeAdvertencia("No se puede guardar el contrato sin definir el cliente.");
            return null;
        }

        if(this.state.contratoData === null) {
            this.mostrarMensajeAdvertencia("No se puede guardar el contrato sin los servicios.");
            return null;
        }

        if(this.detallePagoObj === null) {
            this.mostrarMensajeAdvertencia("No se puede guardar el contrato sin definir los detalles de pago.");
            return null;
        }
        ...
        const cont = {
            ...
            detallePago: this.detallePagoObj
        }
